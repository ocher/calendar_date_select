...
Date.prototype.getPaddedMinutes = function(interval) { return Date.padded2(Math.floor_to_interval(this.getMinutes(), interval)); }
...
CalendarDateSelect.prototype = {
  ...
  dayHover: function(element) {
    ...
    this.updateFooter(hover_date.toFormattedString(this.use_time, this.options.get("minute_interval")));
  },
  ...
  dateString: function() {
    return (this.selection_made) ? this.selected_date.toFormattedString(this.use_time, this.options.get("minute_interval")) : "&#160;";
  },
  parseDate: function()
  {
